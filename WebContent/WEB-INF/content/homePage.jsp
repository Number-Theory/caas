		...
		<div class="homePageContent">
			<table>
				...
				<tr class="productIcon">
					<td><img src="<%=path%>/resources/img/homePage/huibo.png" data-src="<%=path%>/resources/img/homePage/huibo.png" data-hover-src="<%=path%>/resources/img/homePage/huibo1.png" alt=""></td>
					<td><img src="<%=path%>/resources/img/homePage/yhth.png" data-src="<%=path%>/resources/img/homePage/yhth.png" data-hover-src="<%=path%>/resources/img/homePage/yhth1.png" alt=""></td>
					<td><img src="<%=path%>/resources/img/homePage/xnxh.png" data-src="<%=path%>/resources/img/homePage/xnxh.png" data-hover-src="<%=path%>/resources/img/homePage/xnxh1.png" alt=""></td>
					<td><img src="<%=path%>/resources/img/homePage/yyyzm.png" data-src="<%=path%>/resources/img/homePage/yyyzm.png" data-hover-src="<%=path%>/resources/img/homePage/yyyzm1.png" alt=""></td>
					<td><img src="<%=path%>/resources/img/homePage/yytz.png" data-src="<%=path%>/resources/img/homePage/yytz.png" data-hover-src="<%=path%>/resources/img/homePage/yytz1.png" alt=""></td>
				</tr>
...
<script type="text/javascript" src="<%=path%>/resources/js/wySilder.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/TweenLite.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/EasePack.min.js"></script>
...
<script type="text/javascript" src="<%=path%>/resources/js/jquery.fullPage.min.js"></script>
<script type="text/javascript" src="<%=path%>/resources/js/jquery.slimscroll.js"></script>
<script>
	$(function (){
		$('#fullPage').fullpage({
			scrollOverflow:true,
