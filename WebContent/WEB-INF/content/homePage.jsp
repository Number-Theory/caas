	   ...
	   <div class="silder-scroll">
			<div class="silder-main">
				<div class="silder-main-img">
					<img src="<%=path%>/resources/img/homePage/1.jpg" alt="">
				</div>
				<div class="silder-main-img">
					<img src="<%=path%>/resources/img/homePage/2.jpg" alt="">
				</div>
				<div class="silder-main-img">
					<img src="<%=path%>/resources/img/homePage/3.jpg" alt="">
				</div>
				<div class="silder-main-img">
					<img src="<%=path%>/resources/img/homePage/4.jpg" alt="">
				</div>
				<div class="silder-main-img">
					<img src="<%=path%>/resources/img/homePage/5.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
...
<div class="homePageContent">
	<table>
		...
		<tr class="productIcon">
			<td><img src="<%=path%>/resources/img/homePage/huibo.png" alt=""></td>
			<td><img src="<%=path%>/resources/img/homePage/yhth.png" alt=""></td>
			<td><img src="<%=path%>/resources/img/homePage/xnxh.png" alt=""></td>
			<td><img src="<%=path%>/resources/img/homePage/yyyzm.png" alt=""></td>
			<td><img src="<%=path%>/resources/img/homePage/yytz.png" alt=""></td>
		</tr>
