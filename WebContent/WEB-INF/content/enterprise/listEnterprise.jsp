								...
								<table id="tableDemo" class="table table-hover"
									...
									<thead>
										<tr>
											...
											<th data-field="attribute">所属行业</th>
											<th data-field="legalPerson">法人名称</th>
											<th data-field="legalPersonId">法人身份证号</th>
											<th data-field="webSite">网站地址</th>
											<th data-field="addreSS">个人身份证地址</th>
					...
					.bootstrapTable(
							{
								...
								columns : [
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var edit = "/enterprise?id=" + row.id;
												var d = '<a href="' + edit + '" >详情</a> &nbsp;&nbsp;';
												return d;
											}
										}, ]
							});
