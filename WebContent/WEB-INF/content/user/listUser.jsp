                ...
                <div class="row row-lg">   
                    <div class="col-sm-12">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">   
                                <p>	
                        			<button class="btn btn-primary " type="button" onclick="freshdata('formUser')"><i class="fa fa-check"></i>&nbsp;&nbsp;刷新</button>&nbsp;&nbsp;
                                    <button class="btn btn-success " type="button" onclick="adddata('/user/addUser')"><i class="fa fa-upload"></i>&nbsp;&nbsp;<span class="bold">新增 </span></button>&nbsp;&nbsp;
                                    <button class="btn btn-info "    type="button" onclick="editdata('/user/editUser')"><i class="fa fa-paste"></i>&nbsp;&nbsp;编辑</button>&nbsp;&nbsp;
                                    <button class="btn btn-warning " type="button" onclick="deldata('/user/batchDeleteUser')"><i class="fa fa-warning"></i>&nbsp;&nbsp;<span class="bold">删除</span></button>&nbsp;&nbsp;
                                    
                                </p> 
                                <div class="alert alert-success alert-dismissable" id="operateNote"> </div>
                             	<form action="<%=path%>/user/userList" method="post" id="formUser">
				...
				.bootstrapTable(
						{
							...
							columns : [{
										...
										field : 'createType',
										formatter : function(value, row, index) {
											return row.status == 0 ? '自助开户' : '管理员开户';
										}
									}, {
										field : 'userType',
										formatter : function(value, row, index) {
											return row.status == 0 ? '预付费' : '后付费';
										}
									}, {
										field : 'salesMan',
									}, {
										...
										align : 'center',
										formatter : function(value, row, index) {
											var edit = "/user/editUser?id=" + row.id;
