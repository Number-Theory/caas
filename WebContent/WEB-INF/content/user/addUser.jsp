                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" action="<%=path%>/user/addUser" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="userName" name="userName" value="${returnMap.userName }" minlength="1" type="text" class="form-control" required="" aria-required="true" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">邮箱：</label>
                                <div class="col-sm-3">
                                    <input id="email" name="email" value="${returnMap.email }" minlength="1" type="email" class="form-control" required="" aria-required="true" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">手机号码：</label>
                                <div class="col-sm-3">
                                    <input id="mobile" name="mobile" value="${returnMap.mobile }" minlength="1" type="text" class="form-control" required="" aria-required="true" >
                                </div>
                            </div>
