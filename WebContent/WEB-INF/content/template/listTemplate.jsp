							...
							<div class="example">
								<p>
									...
									<button class="btn btn-success " type="button"
										onclick="adddata('/template/addTemplate')">
										<i class="fa fa-upload"></i>&nbsp;&nbsp;<span class="bold">新增
										</span>
									</button>
									&nbsp;&nbsp;
									<button class="btn btn-info " type="button"
										onclick="editdata('/template/editTemplate')">
										<i class="fa fa-paste"></i>&nbsp;&nbsp;编辑
									</button>
									&nbsp;&nbsp;
									<button class="btn btn-warning " type="button"
										onclick="deldata('/template/batchDeleteTemplate')">
								...
								<div class="alert alert-success alert-dismissable"
									id="operateNote"></div>
								<form action="<%=path%>/template/templateList" method="post"
									id="formTemplate">
											...
											<div class="row">
												<div class="col-md-3">
													<input type="text" name="condition" id="condition"
														value="${param.condition }" placeholder="模板名称/模板ID/用户ID"
														class="form-control">
												</div>
												<div class="col-md-3">
					...
					.bootstrapTable(
							{
								...
								columns : [
										...
										},
										{
											...
											formatter : function(value, row,
													index) {
												var edit = "/template/editTemplate?id="
														+ row.id;
