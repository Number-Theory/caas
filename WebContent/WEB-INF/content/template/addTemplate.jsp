            ...
            <div class="col-sm-15">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" action="<%=path%>/template/addTemplate" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-5">
                                    <button class="btn btn-primary" type="button" onclick="addTemplate()">提交添加</button>
                                    <p id="addText"></p>
                                </div>
                            </div>
                        </form>
